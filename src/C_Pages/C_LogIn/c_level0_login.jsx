...
//////////////      HEADER      //////////////
//////////////////////////////////////////////
// File :: c_level0_login.jsx (Component)
    ...
    return (
      <div style={{ position: "relative", height: "100vh", width: "100vw" }}>
        ...
        <div className="cl_row cl_noMark" style={{ pointerEvents: "none", position: "absolute", height: "5vh", width: "100vw", zIndex: "2", top: "95vh", left: "0px" }}>
          <svg onClick={() => this.props.handleGo2Page("/git")} className="cl_Icon_F_BrightBG cl_Icon_F" style={{ height: "4vh", marginLeft: "2vw", marginTop: "0.5vh" }} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16">
            <path
              fillRule={"evenodd"}
