      ...
      <div>
        <CHeader style={{ height: "25vh", width: "100vw" }}>
          <div className="cl_blur cl_row cl_noMark" style={{ position: "absolute", height: "25vh", width: "100vw", zIndex: "2", top: "0px", left: "0px" }}>
            ...
            <svg style={{ height: "20vh", margin: "auto", marginLeft: "5vw", fill: "var(--font-color-point-out)" }} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16">
              <path
                fillRule={"evenodd"}
        ...
        <div style={{ width: "100vw", height: "75vh", background: "var(--bg-point-out-alpha-5)" }}>
          <p style={{ color: "var(--borderColor)", width: "fit-content", maxWidth: "50%", margin: "auto" }}>This Page is not implemented so far.</p>
        </div>
      </div>
    );
  }
