      ...
      <div>
        ...
        <div style={{ width: "60%", widthMax: "80%", margin: "auto", marginTop: "5vh", marginBottom: "5vh" }}>
          ...
          {this.state.contacts.map((c) => (
            <C_Person key={"id_contact_" + c} getAffiliation={this.getAffiliation} person={this.state.persons[c]} />
          ))}
          <h2>Partner</h2>
          {this.state.partners.map((p) => (
            <C_Person key={"id_partner_" + p} getAffiliation={this.getAffiliation} person={this.state.persons[p]} />
          ))}
          <h2>Thanks to: </h2>
          <div className="cl_row" style={{ width: "100%", justifyContent: "center", padding: "5vh 0vw", overflow: "hidden", background: "var(--bg-dark)" }}>
            {this.state.affiliations.map((a) => (
              <C_Affiliation key={"id_affiliations_" + a.id} affiliation={a} />
            ))}
          </div>
