...
class C_Person extends Component {
  render() {
    return <div>{React.createElement("div", {key: "person_"+this.props.person.id, className: "cl_row", style: { marginTop: "5vh", marginBottom: "5vh" } }, [this.getElement_Img(), this.getElement_PersonData(), this.getElement_AffiliationData()])}</div>;
  }
  ...
  getElement_PersonData() {
    ...
    if (!"id" in this.props.person)
      return React.createElement("div", {key: "person_data_"+this.props.person.id}, []);
    ...
    return React.createElement("div", { key: "person_data_"+this.props.person.id, style: { width: "20vw", marginBottom: "auto", marginLeft: "3vw", marginRight: "3vw" } }, [React.createElement("h3", { key: "person_contactLabel_"+this.props.person.id, style: { textAlign: "left" } }, name), contactElement]);
  }
  ...
  getElement_Contact(_contactJSON, _source) {
    ...
    if ("link" in _contactJSON)
      elem2 = React.createElement("div", { key: "person_link_"+_source+this.props.person.id, className: "cl_row" }, [React.createElement("p", { key: "person_link_p_"+_source+this.props.person.id, style: { marginRight: "0.5vw" } }, "Homepage: "), React.createElement("a", { key: "person_link_a_"+_source+this.props.person.id, href: _contactJSON.link, target: "_blank" }, "Link")]);
  ...
  getElement_AffiliationData() {
    if ("affiliation" in this.props.person) {
      ...
      if (affiliation !== undefined) {
        ...
        return React.createElement("div", { key: "person_affiliation_"+this.props.person.id,  style: { marginBottom: "auto", marginRight: "auto", width: "20vw", marginLeft: "auto" } }, [React.createElement("h3", { key: "person_name_"+this.props.person.id, style: { textAlign: "left" } }, name), contactElement]);
      }
    }
